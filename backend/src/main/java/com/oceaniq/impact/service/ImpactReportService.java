...
public class ImpactReportService {
    ...
    public Page<ImpactReportResponse> getReports(
        ...
        /**
         * if search keyword is provided, filters reports by title containing the
         ...
         * converts ImpactReport entities to ImpactReportResponse DTOs and returns
         * paginated result
         */
     ...
     * 
     *         fetches the user and region entities based on IDs provided in the
     *         request
     *         if user or region is not found, throws ResourceNotFoundException
     *         creates a new ImpactReport entity, sets its properties based on the
     *         request and associated user and region
     *         saves the new report to the database and returns the created report
     *         as a DTO
     */
    @Transactional
